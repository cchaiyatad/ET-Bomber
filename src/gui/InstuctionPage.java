...
public class InstuctionPage extends VBox implements HasButtonPage {
	...
	private void createPage() {
		...
		aimOfGameHeader.setFont(Font.loadFont(fontpath, 20));
		aimOfGameHeader.setBackground(bg);
		
		Label aimOfGameContentLabel = new Label(aimOfTheGameContentString);
		aimOfGameContentLabel.setFont(Font.loadFont(fontpath, 14));
		...
		keyBoxHeader.setFont(Font.loadFont(fontpath, 20));
		keyBoxHeader.setBackground(bg);
		
		Label keyContentLabel = new Label(keyString);
		keyContentLabel.setFont(Font.loadFont(fontpath, 14));
		keyContentLabel.setWrapText(true);
		
		Label legendBoxHeader = new Label(" LEGEND ");
		legendBoxHeader.setFont(Font.loadFont(fontpath, 20));
	...
	private GridPane createLegendBox() {
		...
		playeroneImageLabel.setFont(Font.loadFont(fontpath, 14));
		...
		playertwoImageLabel.setFont(Font.loadFont(fontpath, 14));
		...
		playerthreeImageLabel.setFont(Font.loadFont(fontpath, 14));
		...
		playerfourImageLabel.setFont(Font.loadFont(fontpath, 14));
		...
		minionImageLabel.setFont(Font.loadFont(fontpath, 14));
		...
		obstacleImageLabel.setFont(Font.loadFont(fontpath, 14));
		...
		bombUpgradeLabel.setFont(Font.loadFont(fontpath, 14));
		...
		powerImageLabel.setFont(Font.loadFont(fontpath, 14));
		...
		speedImageLabel.setFont(Font.loadFont(fontpath, 14));
		...
		lifeImageLabel.setFont(Font.loadFont(fontpath, 14));
		...
		shieldImageLabel.setFont(Font.loadFont(fontpath, 14));
