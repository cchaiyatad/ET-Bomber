...
public class PushBombSkillItem extends Item implements PowerUp{
	...
	public PushBombSkillItem(int xPosition, int yPosition, Pane layer, GameController gameController) {
		super(xPosition, yPosition, "pushBombItem", layer, gameController);
	}
